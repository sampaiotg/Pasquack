...
void gerLstVar() {
    ...
    do {
        ...
        if(aux->type == 1) {
            dotData(gerFile,saux," db ;ShortInt 1\n");
        } else if(aux->type == 2) {
            dotData(gerFile,saux," db ;Integer 2\n");
        } else if(aux->type == 3) {
            dotData(gerFile,saux," db ;LongInt 3\n");
        } else if(aux->type == 4) {
            dotData(gerFile,saux," db ;Real 4\n");
        } else if(aux->type == 5) {
            dotData(gerFile,saux," db ;Char 5\n");
        }
        free(saux);
        aux = aux->prox;
    } while(aux != NULL);
